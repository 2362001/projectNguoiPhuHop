    ...
    <div className='AboutMe'>
        ...
        <div className='infor'>
          ...
          <div className='infor-about-hunt'>
            ...
            <p>
              ...
              thuyết đúng đắn, chính quy của thế giới về với Việt Nam, nhằm phát triển năng suất của các doanh nghiệp và
              mang lại cuộc sống hạnh phúc cho doanh nhân”.Từ khi thành lập tới nay, J.O.H.N ACADEMY đã thành công đào
              tạo, huấn luyện cho hàng ngàn học viên, là chủ cũng như thành viên nòng cốt của hàng trăm doanh nghiệp
              Việt Nam. Nhiều chủ doanh nghiệp đã tìm ra con đường quản trị đúng đắn, phù hợp dưới sự hỗ trợ của anh Mai
              Xuân Đạt & cộng sự.
            </p>
            <p>
              Trong cuốn sách quản trị kinh điển “Từ tốt đến vĩ đại”, tác giả Jim Collins đã nói rằng: “Tài sản lớn nhất
              của doanh nghiệp không phải là con người, mà là người phù hợp”. Mọi chủ doanh nghiệp đều nhận thức được
              rằng, dù chiến lược có đẹp đẽ, hoành tráng đến mấy mà không có người thực thi thì cũng thành vô nghĩa. Vì
              vậy, để hoàn thiện vòng tròn giá trị mà J.O.H.N ACADEMY muốn trao đến cho doanh nghiệp, chúng tôi quyết
              định ra mắt JOHN HUNT, từ quý II/2022.
            </p>
          </div>
        </div>
      </div>
      <div className='about-me-provide'>
        <div className='infor-provide'>
          <div className='infor-about-provide'>
            ...
            <p>
              Với niềm tin “Tìm người phù hợp là bước đầu tiên của mọi kế hoạch vĩ đại trong doanh nghiệp”, chúng tôi hy
              vọng với sự hỗ trợ của mình, doanh nghiệp sẽ ngày càng vững vàng hơn trên con đường: Tuyển đúng để Tìm
              người phù hợp!
            </p>
      ...
      <div className='work-phil'>
        <div className='work-phil-container'>
          ...
          <p className='content'>
            Chính vì vậy, để có thể mang tới dịch vụ tuyển dụng chất lượng cao nhất tới khách hàng, quy trình tuyển dụng
            của chúng tôi sẽ diễn ra như sau:
          </p>
